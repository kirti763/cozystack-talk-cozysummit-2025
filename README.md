...
* Cloud independence vs vendor lock-in
  
* Moving from consuming cloud resources to building cloud infrastructure
  
* Managed services, multi-tenancy, and cost efficiency
...
* AWS vs Cozystack mental model

* Architecture overview & layers

* Managed Kubernetes, VMs

* Multi-tenancy, identity, cube virtualization
